...
nnoremap <silent> <leader>r :call FozzieCommand('/Users/nick/Documents/ttags/target/release/ttags -f - ' . expand('%:p'), ":", 15, "-l14 split --delimiter=\"\t\" -f0 -o2", "true", "NONE", "#57C7FF", "#F1F1F0")<cr>
